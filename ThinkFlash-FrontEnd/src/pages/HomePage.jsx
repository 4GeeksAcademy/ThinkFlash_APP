					...
					<div className="row">
						<div className="col-md-6">
							<div className="text-container p-4 d-flex flex-column justify-content-center h-100 mb-5">
								...
								<button className="btn btn-lg fw-bold text-bg-dark col-lg-5">¡Comienza ahora!</button>
								</div>
							</div>
						</div>
						<div className="col-md-6">
			...
			<div className="container-xl ">
				<div className="row p-4 g-5 py-5">
					<div className="col-md-4">
						<h5 className="font-weight-normal rounded-3 p-2 text-center text-white bg-dark mb-4">Aprendizaje Personalizado 🧠</h5>
					...
					<div className="col-md-4">
						<h5 className="font-weight-normal rounded-3 p-2 text-center text-white bg-dark mb-4"> Medición Precisa de Progreso 📈</h5>
						<p className="text-muted text-center">
					...
					<div className="col-md-4">
						<h5 className="font-weight-normal rounded-3 p-2 text-center text-white bg-dark mb-4">Flexibilidad en el Aprendizaje 🚀</h5>
						<p className="text-muted text-center">
