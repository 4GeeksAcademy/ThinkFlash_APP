    ...
    return (
        <div>
            <div className="container vh-90 d-flex flex-column justify-content-center align-items-center">
                ...
                <img className="ms-3 mt-1 position-absolute top-50 start-50 translate-middle pulsating-heart" style={{ width: "35vh", height: "30vh" }} src="https://i.ibb.co/Phs1CSV/Logo-2-removebg-preview.png" alt="ThinkFlash Logo" />
            </div>
        </div>
    )
}